...
| `ACCEL_SHORT` | `cu130` | `rocm6.3` |
| PyTorch index | `whl/cu130` | `whl/rocm6.3` |
| Release tag | `torch2.10-cu130` | `torch2.10-rocm6.3` |
...
- Wheels are uploaded directly to a GitHub release.
  ...
  - ROCm tag: `torch{X.Y}-rocm{MAJ}.{MIN}` (e.g., `torch2.10-rocm6.3`)
...
- ROCm: x86_64 only. ROCm toolkit is installed from AMD's APT repository.
